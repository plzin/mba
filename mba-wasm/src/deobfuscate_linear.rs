...
use mba::{bitwise_expr::LBExpr, choose_binary_ring, linear_mba::{self, DeobfuscationConfig}, rings::BinaryRing};
...
pub fn deobfuscate_linear(
    ...
    #[wasm_bindgen(js_name = "detectBoolean")]
    detect_boolean: bool,
    formatter: Formatter,
    ...
    choose_binary_ring!(deobfuscate_linear_impl(
        expr, &cfg, formatter, &r
    ), r = bits)
}
...
fn deobfuscate_linear_impl<R: BinaryRing>(
    ...
    let expr = LBExpr::from_string(expr, ring)
